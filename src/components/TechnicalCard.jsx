...
const TechnicalCard = ({ name, date, desc, points, logo }) => {
  ...
  return (
    <VerticalTimelineElement
      contentStyle={{
        background: "#ffffff00",
        boxShadow: "1px 4px 4px 1px #457b9d",
        borderRadius: "10px",
      }}
    ...
    >
      <h1 className="custom-text-color text-2xl font-custom1 font-semibold tracking-wider ">
        {name}
      </h1>
